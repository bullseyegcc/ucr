  ...
  return (
    <section className="w-full   px-5 md:px-10 py-20">
      <div className="flex flex-col gap-5 items-center text-center mb-14">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-900 leading-tight md:max-w-[80%]">
          Tools that have assisted UCR in upholding its exceptional international standards.
        </h2>
