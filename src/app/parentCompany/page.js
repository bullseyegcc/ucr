...
export default function parentCompany() {
    return (
        <div className="bg-[#F5F5F5]">
            {/* header */}
            <div className="bg-[url('/pcbg.png')] bg-cover bg-bottom bg-no-repeat relative flex min-h-[60vh] md:min-h-[80vh] items-center pt-24 md:pt-46 font-sans flex flex-col gap-6">

                <Badgetextwhite title="Our Logistics" />

                <h1 className="w-full md:w-3/4 lg:w-2/3 text-center text-3xl md:text-5xl font-bold text-white font-inter leading-tight px-6">UCR has a higher delivery capacity in the Copper Industry</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 px-4 md:px-10">
                <div className="relative rounded-xl p-6 sm:p-8 flex flex-col gap-6 bg-white/60">
                 ...
                 <div className="relative rounded-xl p-6 sm:p-8 flex flex-col gap-6 bg-white/60">
                    <Image src="/pc2.png" alt="Icon" className='absolute bottom-0 right-0 max-w-[45%] md:max-w-[55%]' width={250} height={0} />
                    <div className="pb-6">
                 ...
                 <div className="relative rounded-xl p-6 sm:p-8 flex flex-col gap-6 bg-white/60">
                    <Image src="/pc3.png" alt="Icon" className='absolute bottom-0 right-0 max-w-[45%] md:max-w-[55%]' width={250} height={0} />
                    <div className="pb-6">
                 ...
                 <div className="relative rounded-xl p-6 sm:p-8 flex flex-col gap-6 bg-white/60">
                    <Image src="/pc4.png" alt="Icon" className='absolute bottom-3 right-3 max-w-[45%] md:max-w-[55%]' width={250} height={0} />
                    <div className="pb-6">
            ...
            <div className="w-full h-auto md:h-[80vh] pt-12 md:pt-16 px-4 md:px-10 mb-8 bg-[url('/expertisebg.png')] bg-contain bg-top bg-no-repeat bg-cover flex flex-col justify-between">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-end">
                    ...
                    <div className="rounded-xl w-full md:w-1/3 bg-white px-5 pt-10 md:pt-16 relative flex flex-col gap-8 h-auto md:h-[55vh]">
                        <h1 className="pt-5 text-4xl md:text-6xl font-semibold text-primary relative z-10 flex flex-col gap-4 bg-gradient-to-l from-white via-gray-200 to-primary bg-clip-text text-transparent">20+ <hr className="text-primary/30 w-[90%] shadow  " /></h1>


                        <div className="relative z-10 pb-6 ">
                            <h1 className="text-2xl md:text-3xl font-bold mb-2">Years Experience</h1>
                            <p className="w-full md:w-90 pr-0 md:pr-4">200,000 metric tons copper production line that is the largest of its kind in the Middle East.</p>
                    ...
                    <div className="rounded-xl w-full md:w-1/3 bg-white px-5 pt-10 md:pt-16 relative flex flex-col gap-8 h-auto md:h-[50vh]">
                        <h1 className="text-4xl md:text-6xl font-semibold text-primary relative z-10 flex flex-col gap-4 bg-gradient-to-l from-white via-gray-200 to-primary bg-clip-text text-transparent">1500+ <hr className="text-primary/30 w-[90%] shadow  " /></h1>


                        <div className="relative z-10">
                            <h1 className="text-2xl md:text-3xl font-bold mb-2">Employees</h1>
                            <p className="w-full md:w-55">With over 150 experienced employees, we deliver quality and reliability every day.</p>

                        </div>

                        <Image src="/exp2.png" alt="Expertise Icon" width={280} height={80} className=' absolute -bottom-0 right-0 z-0' />

                    </div>

                    <div className="rounded-xl w-full md:w-1/3 bg-white px-5 pt-10 md:pt-16 relative flex flex-col gap-8 h-auto md:h-[45vh]">
                        <h1 className="text-4xl md:text-6xl font-semibold text-primary relative z-10 flex flex-col gap-4 bg-gradient-to-l from-white via-gray-200 to-primary bg-clip-text text-transparent">30+ <hr className="text-primary/30 w-[90%] shadow  " /></h1>


                        <div className="relative z-10">
                            <h1 className="text-2xl md:text-3xl font-bold mb-2">Global Sales</h1>
                            <p className=" w-full md:w-80 pr-0 md:pr-4">We supplies products, services and solutions across over 30 countries in Australia, Asia, Africa, and the Middle East.</p>

                        </div>

                        <Image src="/exp3.png" alt="Expertise Icon" width={240} height={80} className=' absolute -bottom-0 right-0 z-0' />
