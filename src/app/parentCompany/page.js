        ...
        <div className="bg-[#F5F5F5]">
            ...
            >
                ...
                <div className="min-h-[40vh] py-10 relative rounded-xl p-6 sm:p-8 flex flex-col gap-6 bg-white/60 group hover:scale-[1.03] transition-transform duration-500 ease-out">
                    ...
                    <Image src="/pc4.png" alt="Icon" className='z-0 absolute bottom-3 right-3 max-w-[35%] lg:w-50' width={250} height={0} />
                </div>
            </ScrollRevealCardsContainer>
            ...
            <div className="w-full h-auto lg:h-full pt-12 lg:pt-16 px-4 lg:px-10 mb-8 bg-[url('/expertisebg.png')] bg-contain bg-top bg-no-repeat bg-cover flex flex-col justify-between">
                ...
                <div className="mt-6 flex flex-col lg:flex-row gap-6 items-end">
                    ...
                    <CardAnimation index={0} className="min-h-[55vh] lg:min-h-[65vh]  lg:rounded-t-2xl rounded-2xl w-full lg:w-1/3 bg-white px-6 lg:px-8 pt-8 lg:pt-16 relative flex flex-col gap-8 h-[50vh] lg:h-[55vh] group transition-all duration-400">
                        ...
                        <div className="relative z-10 pb-6 ">
                            ...
                            <p className=" lg:w-90 pr-0 lg:pr-4">200,000 metric tons copper production line that is the largest of its kind in the Middle East.</p>

                        </div>

                        <Image src="/exp1.png" alt="Expertise Icon" width={290} height={80} className='w-full absolute -bottom-0 right-0 z-0 rounded-b-2xl lg:rounded-none' />
                    ...
                    <CardAnimation index={1} className="min-h-[55vh] lg:min-h-[60vh] lg:rounded-t-2xl rounded-2xl w-full lg:w-1/3 bg-white px-6 lg:px-8 pt-8 overflow-x-hidden lg:pt-16 relative flex flex-col gap-8 h-[50vh] lg:h-[55vh] group transition-all duration-400">
                        <h1 className="text-[73.03px] leading-[60.05px] tracking-[-1.2px] lg:text-[84px] lg:leading-[69.07px] lg:tracking-[-1.38px] font-medium text-primary relative z-10 flex flex-col gap-4 bg-gradient-to-l from-white via-gray-200 to-primary bg-clip-text text-transparent">
                            <span><CountUp to={1500} duration={2.5} />+</span> <hr className="text-primary/30 w-[90%] shadow  " />
                        </h1>
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="w-45 lg:w-55">With over 150 experienced employees, we deliver quality and reliability every day.</p>

                        </div>

                        <Image src="/exp2.png" alt="Expertise Icon" width={180} height={80} className='w-60 lg:w-76 absolute -bottom-0 -right-5 lg:right-0 z-0 rounded-b-2xl lg:rounded-none' />
                    ...
                    <CardAnimation index={2} className="min-h-[55vh] lg:min-h-[55vh] lg:rounded-t-2xl rounded-2xl w-full lg:w-1/3 bg-white px-6 lg:px-8 pt-8 lg:pt-16 relative flex flex-col gap-8 h-[50vh] lg:h-[55vh] group transition-all duration-400">
                        ...
                        <Image src="/exp3.png" alt="Expertise Icon" width={300} height={80} className=' absolute -bottom-0 right-0 z-0 rounded-b-2xl lg:rounded-none' />
