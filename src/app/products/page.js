                    ...
                    <div className="w-full px-2 lg:px-10 ">
                        ...
                        <div className="w-full">
                            {products.slice(1).map((product, idx) => (
                                <div key={product.id} className="relative text-[#5F5F66] bg-white rounded-xl p-8 mb-12 flex items-center justify-between hover:shadow-lg gap-6 transition-shadow cursor-pointer group overflow-hidden">
                                    ...
                                    <div className="hidden group-hover:block w-full lg:w-[22%] lg:ml-8 bg-white rounded-lg ">
                                        <Image src="/drawnwire.png" alt="Icon" width={300} height={300} className="w-full h-full object-cover" />
                                    </div>
