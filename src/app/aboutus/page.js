  ...
  return (
    <div className="">
      ...
      <div className="mx-auto min-h-screen relative mb-8 lg:mb-0 w-full max-w-[1600px]">
        <div className="min-h-[40vh] sm:min-h-[50vh] w-full bg-[url('/about/parentcompanybg.svg')] bg-cover bg-center lg:bg-top bg-no-repeat rounded-xl sm:rounded-2xl flex flex-col justify-end lg:justify-start px-4 sm:px-5 lg:px-16 py-8 sm:py-12">
          <div className="flex flex-col sm:flex-row justify-start items-center gap-2 sm:gap-3 text-white z-10 lg:absolute lg:left-16 lg:top-[calc(100%-70vh)]">
            <Image
              src="/badge-w.png"
              alt="Badge Icon"
              width={34}
      ...
      <ParallaxSection index={0}>
        <div className="mb-8 w-full max-h-[90vh] bg-[url('/expertisebg.png')] bg-cover bg-top bg-no-repeat pt-12 lg:max-h-[95vh] lg:pt-16">
      ...
      <ParallaxSection index={1}>
        <div className="mx-auto w-full max-w-[1600px] flex flex-col lg:flex-row justify-center items-stretch min-h-auto lg:min-h-screen px-1 sm:px-6 lg:px-10 gap-4 sm:gap-6 lg:gap-8 py-6 sm:py-8 lg:py-12 relative -z-10">
          <VideoCard
