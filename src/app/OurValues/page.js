                ...
                <div className="w-full mx-auto">
                    ...
                    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-9 lg:gap-12 mb-12 lg:mb-16">
                        ...
                        <ScrollRevealCardsContainer
                            ...
                            pinOnMobile={false}
                        >
                            <div className="bg-[#FDF5F3] rounded-xl p-6 lg:p-8 flex flex-col gap-6 group transition-all duration-500 ease-out hover:scale-[1.03] hover:-translate-y-1 hover:shadow-2xl">
                            ...
                            <div className="bg-[#FDF5F3] text-center rounded-xl p-6 lg:p-8 flex flex-col items-center gap-6 group transition-all duration-500 ease-out hover:scale-[1.03] hover:-translate-y-1 hover:shadow-2xl">
