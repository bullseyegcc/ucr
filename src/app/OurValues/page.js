...
export default function OurValues() {
    return (
        <div className="">
                ...
                <div className="w-full mx-auto">
                    ...
                    <div className="w-full flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4  lg:gap-12 mb-12 lg:mb-16">
                        <SlideIn direction="left" duration={0.8} className="">
                            ...
                            <h1 className="font-medium text-[26px] leading-[48px] tracking-[-1.4px] lg:w-[80%] lg:text-[52px] lg:leading-[64px] text-black mt-4 lg:mt-6 uppercase">Beyond copper, we build trust & reliability</h1>
                        </SlideIn>
                        <SlideIn direction="right" duration={0.8} className=" lg:pt-12">
                            <p className=" text-ellipsis text-[#212225] text-[16px] font-normal leading-[30px] tracking-[-0.45px] lg:text-[18px]">We don't just produce copper — we shape reliability, innovation, and sustainability into every product we deliver.</p>
                        </SlideIn>
                    </div>
                        ...
                        >
                            ...
                            <div className="min-h-[50vh] max-h-auto bg-[#FDF5F3] rounded-xl p-6 lg:p-8 flex flex-col justify-between gap-6 group transition-all duration-500 ease-out">
                                <Image src="/path.png" alt="Icon" width={120} height={0} className="transition-transform duration-400" />
                                <div>
                            ...
                            <div className="min-h-[50vh] max-h-auto bg-[#FDF5F3] rounded-xl p-6 lg:p-8 flex flex-col justify-between gap-6 group transition-all duration-500 ease-out">
                                <Image src="/reliable.png" alt="Icon" width={120} height={0} className="transition-transform duration-400" />
                                <div>
                            ...
                            <div className="bg-[#FDF5F3] text-center rounded-xl p-6 lg:p-8 flex flex-col items-center gap-6 group transition-all duration-500 ease-out">
                                <Image src="/moreThanCopper.png" alt="Icon" width={300} height={90} className="transition-transform duration-400" />
                            ...
                            <div className="min-h-[50vh] max-h-auto bg-[#FDF5F3] rounded-xl p-6 lg:p-8 flex flex-col justify-between gap-6 group transition-all duration-500 ease-out">
                                <Image src="/careforfuture.png" alt="Icon" width={120} height={0} className="transition-transform duration-400" />
                                <div>
                            ...
                            <div className="min-h-[50vh] max-h-auto bg-[#FDF5F3] rounded-xl p-6 lg:p-8 flex flex-col justify-between gap-6 group transition-all duration-500 ease-out">
                                <Image src="/grow.png" alt="Icon" width={120} height={0} className="transition-transform duration-400" />
                                <div>
            ...
            {/* people */}
            <div className="min-h-screen  bg-[url('/people.png')] bg-cover pt-6   bg-bottom bg-no-repeat">
